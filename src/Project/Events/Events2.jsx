        ...
        <div className="container">
            <div className="row">
                <article className="col-xs-12 col-sm-8">
                    <h1>{props.eventsItem[1].title}</h1>
                    <HTMLText format = {props.eventsItem[1].text}/>
                    <time dateTime={props.eventsItem[1].timeStamp}>{props.eventsItem[1].displayTime}</time>
                    <div>Departments</div>
                    <div>{props.eventsItem[1].department}</div>
                </article>
                ...
                <div className="col-xs-0 col-sm-3 col-sm-offset-1">
                    <div className="sidebar-module">
                        ...
                        <ul className="list-inline">
                            ...
                            <li className="margin-top">
                                <Link to="/events3">{props.eventsItem[2].title}</Link>
