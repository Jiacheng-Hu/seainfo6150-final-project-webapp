...
const Policy = () => {
    ...
    return (
        <div className="policy-main container">
            <h1 className="policy-title">Privacy Information</h1>
            <h3>WELCOME</h3>
            <p>
                June 11,2018: (“University”, “Northeastern”, “we”, “us” or “our”) is a U.S.-based institution of higher learning offering undergraduate, graduate and continuing education programs, curriculum content and services, in a traditional campus setting and through our central websites (each a “Site”) Northeastern.edu, neu.edu, the my Northeastern portal, and our mobile applications (“Apps”) (collectively, the “Services”).
            </p>
            <h3>SCOPE</h3>
            <p>
            ...
            <p>
                For more information about this Privacy Statement, and your rights under applicable law, please contact us at <a href="mailto:privacy@northeastern.edu">privacy@northeastern.edu</a>.
            </p>
            ...
            <ul>
                <li>Name, title, age and date of birth</li>
                <li>Social Security Number (SSN) as required by law for applicants for admission and financial aid, employees and for validation purposes, the last 4 digits are required for sponsored network account applicants</li>
                <li>Northeastern University (NUID) Number (as the student identification number and as an administrative system identifier for faculty and staff)</li>
                <li>Contact information including address, city, state, postal code, country of residence, email address, home, cellular and other contact telephone number(s)</li>
                <li>Campus address and telephone number</li>
                <li>Emergency contact information (names, phone numbers and email addresses)</li>
                <li>Academic credentials</li>
                <li>Academic, leisure or other interests</li>
                <li>Attendance at University events</li>
                <li>Records of communications between you and the university</li>
                <li>Other information pertinent to your specific interests and activities at Northeastern</li>
            </ul>
            <p>
            ...
            <h4>Social Network or Third Party Plug-ins or Widgets</h4>
            <p>
